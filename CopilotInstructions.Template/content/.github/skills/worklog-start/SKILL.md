...
3. relevant numbered current work documents directly under `.worklog/`
...
4. If it needs one:
   - determine the next `NNNN` number by scanning both `.worklog/NNNN.*.md` and `.worklog/archive/NNNN.*.md`;
